...
// disply data according to user  and test run
...
//         // Projects (Test Project doctype)
//         frappe.call({
//             method: "frappe.client.get_list",
//             args: {
//                 doctype: "Test Project",
//                 fields: ["name","title"]   // use "title" because that's your project field
//             },
//             callback: function(r) {
//                 if (r.message) {
...
//                         type: 'bar',
//                         height: 300,
//                         colors: ['#28a745', '#dc3545', '#6c757d']  // Pass, Fail, Not Run
//                     });
//                 } else {
        ...
        frappe.call({
            ...
            callback: function(r) {
                ...
                if (Object.keys(s).length) {
                    ...
                    // On click pie slice → Test Case list
